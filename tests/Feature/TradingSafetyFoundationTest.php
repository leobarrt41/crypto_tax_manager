...
class TradingSafetyFoundationTest extends TestCase
{
    ...
    {
        $this->assertContains(Schema::getColumnType('user_api_keys', 'api_key'), ['text', 'varchar']);
        $this->assertContains(Schema::getColumnType('user_api_keys', 'secret_key'), ['text', 'varchar']);
